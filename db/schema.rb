...
ActiveRecord::Schema.define(version: 20150309224816) do
  ...
  add_index "stories", ["anon"], name: "index_stories_on_anon", using: :btree
  ...
  create_table "users", force: true do |t|
    ...
    t.boolean  "flat_comments",                         default: false
  end
